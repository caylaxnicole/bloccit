  ...
  describe("GET /advertisements", () => {
    it("should return a status code 200 and all ads", (done) => {
      request.get(base, (err, res, body) => {
        ...
        expect(body).toContain("Code School AD");
        done();
      });
    });
  });
  ...
  describe("POST /advertisements/create", () => {
    ...
    it("should create a new advertisement and redirect", (done) => {
      request.post(options, (err, res, body) => {
        Advertisement.findOne({where: {title: "nike ad"}})
        .then((advertisement) => {
          expect(res.statusCode).toBe(303);
          expect(advertisement.title).toBe("nike ad");
  ...
  describe("POST /advertisements/:id/update", () => {
    it("should update the advertisement with the given values", (done) => {
      const options = {
        ...
        form: {
          title: "Code School Advertisements",
          description: "There is a lot of them"
        }
      };
      request.post(options, (err, res, body) => {
        ...
        .then((advertisement) => {
          expect(advertisement.title).toBe("Code School Advertisements");
          done();
        });
      });
    });
